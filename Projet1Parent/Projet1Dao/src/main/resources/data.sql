...
INSERT INTO `article`(id, stock_id, categorie_id, nom, descriptif, image , quantiteVendue, prix, prixKilo) VALUES (6, 6, 5, 'Ciboulette fraîche', 'Bouquet de ciboulette fraîche de 20 g pour agrémenter toutes vos recettes. Origine / Calibre : 20 gr - France - Catégorie : 1', 'chouVert.jpg', '0.02', '1.44', '72.00');
...
INSERT INTO `article`(id, stock_id, categorie_id, nom, descriptif, image , quantiteVendue, prix, prixKilo) VALUES (8, 8, 2, 'Clémentine', 'La chair sucrée et douce de la clémentine, la classe première au hit-parade des agrumes. Ouvrez la clémentine en quartiers avec tendresse, avant de la déguster. Origine / Calibre : 1 kg - France - Cal : 2 - Catégorie : 1', 'clementine.jpg', '0.50', '3.99', '3.99');
INSERT INTO `article`(id, stock_id, categorie_id, nom, descriptif, image , quantiteVendue, prix, prixKilo) VALUES (9, 9, 3, 'Courge butternut', 'Préparez une soupe de courge butternut ou un délicieux velouté ou encore une savoureuse purée qui sera doucement sucrée et musquée. Origine / Calibre : 1.2 kg - France - Catégorie : 1', 'courgeButternut.jpg', '1.00', '3.95', '3.95');
INSERT INTO `article`(id, stock_id, categorie_id, nom, descriptif, image , quantiteVendue, prix, prixKilo) VALUES (10, 10, 3, 'Endives', 'L''endive est un des légumes les plus simples à préparer. Crue, cuite, en salade, vous n''avez que l''embarras du choix . Origine / Calibre : 1 kg - France - Catégorie : 1', 'endive.jpg', '1.00', '2.97', '2.97');
INSERT INTO `article`(id, stock_id, categorie_id, nom, descriptif, image , quantiteVendue, prix, prixKilo) VALUES (11, 11, 2, 'Kiwis', 'Originaire de Chine, puis implanté en Nouvelle-Zélande, ce fruit fut implanté en France dans les années 70. Il peut se consommer plus ou moins mûr selon que vous le préfériez fondant et sucré ou bien plus ferme et un rien acidulé. Origine / Calibre : 6 fruits - 500 gr- France - Catégorie : 1', 'kiwi.jpg', '0.50', '4.65', '9.30');
